...
class DatabaseHelper {
  ...
  // inserted row.
  Future<int> insert(Car car,String id) async {
    Database? db = await instance.database;
    return await db!.insert(table, {'name': car.name, 'miles': car.miles,'userid':id});
  }
  ...
  Future<List<Map<String, dynamic>>> queryRows(name) async {
    print(name);
    Database? db = await instance.database;
    return await db!.query(table, where: "$columnUserId LIKE '%$name%'");
  }
